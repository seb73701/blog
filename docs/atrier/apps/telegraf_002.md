---
title: Installation de Telegraf sous CentOS / RHEL
description: 
published: true
date: 2023-04-21T10:49:56.792Z
tags: 
editor: markdown
dateCreated: 2023-04-21T10:49:52.161Z
---

====== Installation de Telegraf sous CentOS / RHEL ======
----

===== Prérequis =====

Le package **Telegraf** doit être installé avec les droits **''root''** ou **''administrateur (administrator)''**.

Telegraf utilise l'horodatage UTC en local pour définir les ''timestamps'' des données. Il faut s'assurer que le service NTP est bien configuré et fonctionnel.

===== Installation sous CentOS =====

  * Intégration du repo dans ''Yum'' :
...
cat <<EOF | sudo tee /etc/yum.repos.d/influxdb.repo
  ...
  * Purger le cache de ''Yum'' :

<code>yum clean all</code>

  * Installation du package

<code>yum install telegraf</code>

ou 

<code>
# wget https://dl.influxdata.com/telegraf/releases/telegraf-1.8.0-1.x86_64.rpm
# yum localinstall telegraf-1.8.0-1.x86_64.rpm
</code>

  * Activation du service au démarrage :

<code>systemctl enable telegraf</code>
...
==== Fichier de configuration avec les plugins d'entrées / sorties par défaut ====

Par défaut, Telegraf à un fichier de configuration global qui se trouve dans ''/etc/telegraf/telegraf.conf''.

Tous les plugins vont être dans ce fichier, mais la plupart seront commentés.

Le fichier permet de configuré les informations concernant l'agent mais aussi les entrées (input) et les sorties (output).

Voici un exemple de fichier de configuration lié à la version 1.8 de Telegraf :
